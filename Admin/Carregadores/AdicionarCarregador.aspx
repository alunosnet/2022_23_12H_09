<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdicionarCarregador.aspx.cs" Inherits="Nº9_12ºH___M17AB_Trabalho_Final.Admin.Carregadores.AdicionarCarregador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="from-group">
        <label for="ContentPlaceHolder1_dd_empresa">Empresa:</label>
        <asp:DropDownList CssClass="form-control" runat="server" ID="dd_empresa"/><br />
    </div>
    <div class="from-group">
